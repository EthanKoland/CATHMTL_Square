...
def resnet34(pretrained=True, extra_dim=0):
    model = ResNet(BasicBlock, [3, 4, 6, 3], extra_dim)
    if pretrained:
        load_weights_add_extra_dim(model, model_zoo.load_url(model_urls['resnet34']), extra_dim)
    return model
